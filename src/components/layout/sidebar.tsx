    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "fixed inset-y-0 left-0 z-40 flex h-full w-64 flex-col border-r border-sidebar-border bg-sidebar transition-colors duration-200",
      ...
      >
        ...
        <div className="flex h-14 shrink-0 items-center justify-between gap-2 border-b border-sidebar-border px-4">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close menu"
            className="flex h-9 w-9 items-center justify-center rounded-md text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground lg:hidden"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="shrink-0 border-t border-sidebar-border p-3">
          <DropdownMenu>
            ...
            <DropdownMenuContent
              ...
              side="top"
              sideOffset={6}
              className="min-w-56 bg-popover text-popover-foreground border border-border shadow-md"
            >
              <DropdownMenuItem
                render={
                  <Link
